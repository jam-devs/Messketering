    ...
    <div class="login-page">
      <mat-card class="login-card">
        ...
        <div class="demo-accounts">
          <p>Demo accounts:</p>
          <small>admin@caterdash.com / admin123</small>
          <small>kitchen@caterdash.com / kitchen123</small>
          <small>logistics@caterdash.com / logistics123</small>
        </div>
      </mat-card>
    </div>
  `,
