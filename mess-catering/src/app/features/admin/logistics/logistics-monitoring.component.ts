...
@Component({
  ...
  standalone: true,
  imports: [
    AsyncPipe, DatePipe, RouterLink, NgIf,
    MatCardModule, MatIconModule, MatButtonModule, MatChipsModule,
    PageHeaderComponent,
  ],
  template: `
    <ng-container *ngIf="auth.hasRole('admin','logistics'); else unauthorized">
      <app-page-header
    ...
    <ng-template #unauthorized>
      <app-page-header title="Logistics Monitoring" subtitle="Access denied" />
      <mat-card class="empty-state">You do not have permission to view logistics monitoring.</mat-card>
    </ng-template>
  `,
})
