...
@Component({
  ...
  template: `
    <ng-container *ngIf="auth.hasRole('admin','kitchen'); else unauthorized">
      <app-page-header
    ...
    <ng-template #unauthorized>
      <app-page-header title="Kitchen Monitoring" subtitle="Access denied" />
      <mat-card class="empty-state">You do not have permission to view kitchen monitoring.</mat-card>
    </ng-template>
  `,
})
