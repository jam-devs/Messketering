...
@Component({
  ...
  standalone: true,
  imports: [
    AsyncPipe, CurrencyPipe, MatCardModule, MatIconModule, MatButtonToggleModule, NgIf,
    PageHeaderComponent, ChartCardComponent,
  ],
  template: `
    <ng-container *ngIf="auth.hasRole('admin'); else unauthorized">
    ...
    <ng-template #unauthorized>
      <app-page-header title="Reports & Analytics" subtitle="Access denied" />
      <mat-card class="empty-state">You do not have permission to view reports.</mat-card>
    </ng-template>
